    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('admin.price.car.store') }}" method="POST">
                        @csrf
                        <div class="space-y-6">
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <div class="mt-1 relative rounded-md shadow-sm">
                                            <input type="number" name="price_6h" id="price_6h" value="{{ old('price_6h') }}"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                                min="0" required>
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1 relative rounded-md shadow-sm">
                                            <input type="number" name="price_12h" id="price_12h" value="{{ old('price_12h') }}"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                                min="0" required>
                                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                                <span class="text-gray-500 sm:text-sm">円</span>
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1 relative rounded-md shadow-sm">
                                            <input type="number" name="price_24h" id="price_24h" value="{{ old('price_24h') }}"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                                min="0" required>
                                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                                <span class="text-gray-500 sm:text-sm">円</span>
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1 relative rounded-md shadow-sm">
                                            <input type="number" name="price_48h" id="price_48h" value="{{ old('price_48h') }}"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                                min="0" required>
                                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                                <span class="text-gray-500 sm:text-sm">円</span>
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1 relative rounded-md shadow-sm">
                                            <input type="number" name="price_72h" id="price_72h" value="{{ old('price_72h') }}"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                                min="0" required>
                                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                                <span class="text-gray-500 sm:text-sm">円</span>
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1 relative rounded-md shadow-sm">
                                            <input type="number" name="price_168h" id="price_168h" value="{{ old('price_168h') }}"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                                min="0" required>
                                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                                <span class="text-gray-500 sm:text-sm">円</span>
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-1 relative rounded-md shadow-sm">
                                            <input type="number" name="price_extra_hour" id="price_extra_hour" value="{{ old('price_extra_hour') }}"
                                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                                min="0" required>
                                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                                <span class="text-gray-500 sm:text-sm">円</span>
